# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 10:38:29 2019
...
def show_pic(img, file,bboxes=None,measure=None):
    '''
    输入:
        img:图像array
        ...
        names:每个box对应的名称
    '''
    file = file.split('.')[0].split('-')[0]+'.'+file.split('.')[1]
    save_file = os.path.join('E:\\tools code\\example\\out',measure+'-'+file)
    ...
    def dataAugment(self, img, bboxes):
        ...
        while change_num < 1:   #默认至少有一种数据增强生效
            if random.random() < self.crop_rate:        #裁剪
                ...
                show_pic(img,file, bboxes,'jiancai') # 强化后的图
                #break;
            ...
            if random.random() > self.rotation_rate:    #旋转
                ...
                show_pic(img,file, bboxes,'xuanzhuan') # 强化后的图
                #break;
            ...
            if random.random() < self.shift_rate:        #平移
                ...
                show_pic(img,file, bboxes,'pingyi') # 强化后的图
                #break;
            ...
            if random.random() > self.change_light_rate: #改变亮度
                ...
                show_pic(img,file, bboxes,'liangdu') # 强化后的图
                #break;
            ...
            if random.random() < self.add_noise_rate:    #加噪声
                ...
                show_pic(img,file, bboxes,'zaosheng') # 强化后的图
                #break;
            ...
            if random.random() < self.cutout_rate:  #cutout
                ...
                show_pic(img,file, bboxes,'cutout') # 强化后的图
                #break;
            ...
            if random.random() < self.flip_rate:    #翻转
                ...
                show_pic(img,file, bboxes,'fanzhuan') # 强化后的图
                #break;
            #print('\n')
        print('-------------')
        return img, bboxes
...
if __name__ == '__main__':
    ...
    source_pic_root_path = 'E:\\tools code\\example\\images'
    source_xml_root_path = 'E:\\tools code\\example\\annotation'
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        for file in files:
            ...
            while cnt < need_aug_num:
                ...
                #show_pic(img, file,coords)    # 原图
                
                print(file)
                auged_img, auged_bboxes = dataAug.dataAugment(img, coords)
                #print(auged_bboxes)
                #show_pic(auged_img,file, auged_bboxes) # 强化后的图
                #cv2.imwrite('1.jpg', auged_img)
                #cv2.imshow('pic', auged_img)
                #cv2.waitKey(0)
                #cv2.destroyAllWindows()
                cnt += 1
    #print(auged_img)
